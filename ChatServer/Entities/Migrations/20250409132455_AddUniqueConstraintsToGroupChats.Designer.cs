...
namespace Entities.Migrations
{
    ...
    [Migration("20250409132455_AddUniqueConstraintsToGroupChats")]
    partial class AddUniqueConstraintsToGroupChats
    {
            ...
            modelBuilder.Entity("Entities.Models.GroupChatModels.GroupChat", b =>
                {
                    ...
                    b.HasIndex(new[] { "SubjectId", "GroupId" }, "IX_GroupChats_SubjectId_GroupId_Unique_StudentGroup")
                        .IsUnique()
                        .HasFilter("[GroupId] IS NOT NULL AND [IsStudentGroup] = 1");

                    b.HasIndex(new[] { "SubjectId" }, "IX_GroupChats_SubjectId_Unique_SubjectGroup")
                        .IsUnique()
