...
export class QuestionOtherTestComponent
  ...
  implements OnInit
{
  ...
  constructor(
    public dialogRef: MatDialogRef<QuestionOtherTestComponent>,
    ...
    this.testService
      ...
      .pipe(
        tap((tests: Test[]) => {
          ...
          this.tests = tests.sort((n1, n2) =>
            n1.Title.toLowerCase() > n2.Title.toLowerCase() ? 1 : -1
          )
        }),
  ...
  onYesClick(): void {
    ...
    this.testService
      .AddQuestionsFromAnotherTest(this.request)
      .pipe(
  ...
  public onValueChange(event): void {
    this.testService
      .getQuestionsFromOtherTest(event.option.value.Id)
      ...
      .subscribe((questions) => {
        ...
        this.filteredQuestions.sort(
          (a, b) =>
            a.tooltipTitle.toLocaleLowerCase().charCodeAt(0) -
            b.tooltipTitle.toLocaleLowerCase()[0].charCodeAt(0)
        )
      })
  }
