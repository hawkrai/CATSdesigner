...
export class EditAvailabilityPopupComponent
  ...
  implements OnInit
{
  ...
  constructor(
    public dialogRef: MatDialogRef<EditAvailabilityPopupComponent>,
  ...
  ngOnInit() {
    ...
    this.testService
      .getGroupsBySubjectId(subject?.id)
  ...
  public changeTestAvailability(event: any): void {
    let testAvailabilityRequest: TestAvailabilityRequest =
      new TestAvailabilityRequest()
    ...
    this.testService
      .changeAvailabilityForStudent(testAvailabilityRequest)
      .pipe(takeUntil(this.unsubscribeStream$))
      .subscribe(() => {
        this.getSubGroups()
  ...
  public changeTestAvailabilityForAll(event: any): void {
    ...
    this.testService
      .changeAvailabilityForAllStudents(testAvailabilityRequest)
      .pipe(takeUntil(this.unsubscribeStream$))
      .subscribe(() => {
        this.getSubGroups()
        this.cdr.detectChanges()
