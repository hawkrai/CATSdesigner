...
export class FormUtils {
  public static addErrorForControl(
  ...
  public static deleteErrorFromControl(
    control: AbstractControl,
    errorName: string
  ): void {
  ...
  public static isFormValid(formGroup: FormGroup): boolean {
    return Object.keys(formGroup.controls).every(
      (key) =>
        ...
        !!formGroup.controls[key].errors['warning']
    )
  }
  ...
  public static updateControls(
    ...
    Object.keys(formGroup.controls).forEach((key) =>
      formGroup.controls[key].setValue(o[key])
    )
  }
  ...
  public static updateObject(
    ...
    Object.keys(formGroup.controls).forEach(
      (key) => (o[key] = formGroup.controls[key].value)
    )
  }
}
