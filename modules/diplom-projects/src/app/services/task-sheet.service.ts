...
export class TaskSheetService {
  ...
  public getTaskSheetHtml(params: any): Observable<any> {
    return this.http.get('api/DpTaskSheetHtml', {
      params: new HttpParams({ fromObject: params }),
    })
  }

  public getTaskSheet(params: any): Observable<any> {
    return this.http.get('api/DpTaskSheet', {
      params: new HttpParams({ fromObject: params }),
    })
  }
  ...
  public getStudents(params: any): Observable<any> {
    return this.http.get('api/DiplomStudent', {
      params: new HttpParams({ fromObject: params }),
    })
  }
  ...
  public getTemplate(params: any): Observable<any> {
    return this.http.get('api/DpTaskSheetTemplate', {
      params: new HttpParams({ fromObject: params }),
    })
  }
  ...
  public deleteTemplate(params: any): Observable<any> {
    return this.http.delete('api/DpTaskSheet', {
      params: new HttpParams({ fromObject: params }),
    })
  }
}
