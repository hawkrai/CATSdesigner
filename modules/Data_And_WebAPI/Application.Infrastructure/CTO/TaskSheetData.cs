...
namespace Application.Infrastructure.CTO
{
    public class TaskSheetData
    {
        ...
        public string DateEndString => DateEnd.HasValue ? DateEnd.Value.ToString("dd-MM-yyyy") : null;


        public DateTime? DateStart { get; set; }

        public string DateStartString => DateStart.HasValue ? DateStart.Value.ToString("dd-MM-yyyy") : null;
