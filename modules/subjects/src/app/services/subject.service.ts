...
export class SubjectService {
  ...
  public editGroups(subjectId: number, groupId: number): Observable<any> {
    return this.http.get(
      `Subject/SubGroups?subjectId=${subjectId}&groupId=${groupId}`
    )
  }

  public subGroupsChangeGroup(
    subjectId: number,
    groupId: string
  ): Observable<any> {
    return this.http.post('Subject/SubGroupsChangeGroup', {
      subjectId,
      groupId,
    })
  }
  ...
  public getAttachmentsAsZip(
    attachmentsIds: number[]
  ): Observable<HttpResponse<ArrayBuffer>> {
    return this.http.post(
      'Subject/GetAttachmentsAsZip',
      { attachmentsIds },
  ...
  public getLector(id: number): Observable<Lector> {
    return this.http
      .get(`Services/CoreService.svc/GetLecturer/${id}`)
      .pipe(map((res) => res['Lector']))
  }
  ...
  public joinedLector(subjectId: number, lectorId: number): Observable<any> {
    return this.http.post('Services/CoreService.svc/JoinLector', {
      subjectId,
      lectorId,
    })
  }
  ...
  public disjoinLector(subjectId: number, lectorId: number): Observable<any> {
    return this.http.post('Services/CoreService.svc/DisjoinLector', {
      subjectId,
      lectorId,
    })
  }
  ...
  public getNoAdjointLectors(subjectId: number): Observable<Lector[]> {
    return this.http
      .get('Services/CoreService.svc/GetNoAdjointLectors/' + subjectId)
      .pipe(map((res) => res['Lectors']))
  }
  ...
  isUniqueSubjectName(
    subjectName: string,
    subjectId: number
  ): Observable<UniqueViewData> {
    return this.http.post<UniqueViewData>(
      'Services/Subjects/SubjectsService.svc/Name/Unique',
  ...
  isUniqueSubjectAbbreviation(subjectAbbreviation: string, subjectId: number) {
    return this.http.post<UniqueViewData>(
      'Services/Subjects/SubjectsService.svc/Abbreviation/Unique',
      { subjectAbbreviation, subjectId }
    )
  }
}
