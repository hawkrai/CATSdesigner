...
export class NewsRestService {
  ...
  public getAllNews(subjectId: number): Observable<News[]> {
    return this.http
      .get('Services/News/NewsService.svc/GetNews/' + subjectId)
      .pipe(map((res) => res['News']))
  }
  ...
  public disableNews(subjectId: number): Observable<any> {
    return this.http.post('Services/News/NewsService.svc/DisableNews', {
      subjectId,
    })
  }

  public enableNews(subjectId: number): Observable<any> {
    return this.http.post('Services/News/NewsService.svc/EnableNews', {
      subjectId,
    })
  }

  public deleteNews(id: number, subjectId: number): Observable<any> {
    return this.http.post('Services/News/NewsService.svc/Delete', {
      id,
      subjectId,
    })
  }
