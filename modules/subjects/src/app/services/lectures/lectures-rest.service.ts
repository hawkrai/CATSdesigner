...
export class LecturesRestService {
  ...
  public getLectures(subjectId: number): Observable<Lecture[]> {
    return this.http
      .get('Services/Lectures/LecturesService.svc/GetLectures/' + subjectId)
  ...
  public updateLecturesOrder(
    subjectId: number,
    prevIndex: number,
    curIndex: number
  ): Observable<any> {
    return this.http.post(
      'Services/Lectures/LecturesService.svc/UpdateLecturesOrder',
      { subjectId, prevIndex, curIndex }
    )
  }

  public deleteLecture(lecture: {
    id: number
    subjectId: number
  }): Observable<any> {
    return this.http.post(
      'Services/Lectures/LecturesService.svc/Delete',
      lecture
    )
  }
  ...
  public getCalendar(subjectId: number): Observable<Calendar[]> {
    return this.http
      .get('Services/Lectures/LecturesService.svc/GetCalendar/' + subjectId)
      .pipe(map((res) => res['Calendar']))
  }

  public getLecturesMarkVisiting(
    subjectId: number,
    groupId: number
  ): Observable<GroupsVisiting> {
    const params = new HttpParams()
      .set('subjectId', subjectId.toString())
      .set('groupId', groupId.toString())
    return this.http
      .get('Services/Lectures/LecturesService.svc/GetLecturesMarkVisitingV3', {
        params,
      })
      .pipe(
  ...
  public deleteAllDate(body: { dateIds: number[] }): Observable<any> {
    return this.http.post(
      'Services/Lectures/LecturesService.svc/DeleteVisitingDates',
      body
    )
  }

  public setLecturesVisitingDate(body: {
    lecturesMarks: LecturesMarksVisiting[]
  }): Observable<any> {
    return this.http.post(
      'Services/Lectures/LecturesService.svc/SaveMarksCalendarData',
      body
    )
  }

  public getVisitingExcel(
    subjectId: number,
    groupId: number
    ...
    return this.http.get('Statistic/GetVisitLecture', {
      params,
      responseType: 'blob',
      observe: 'response',
    })
