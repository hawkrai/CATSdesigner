...
export const loadLabsSchedule = createAction('[Labs] Load Labs Schedule')
...
export const resetLabs = createAction('[Labs] Reset Labs')
...
export const loadLabStudents = createAction('[Labs] Load Lab Students')
...
export const getMarksExcel = createAction('[Labs] Get Marks Excel')

export const getVisitingExcel = createAction('[Labs] Get Visiting Excel')

export const getLabsAsZip = createAction('[Labs] Get Labs As Zip')
...
export const checkJobProtections = createAction('[Labs] Check Job Protection')
