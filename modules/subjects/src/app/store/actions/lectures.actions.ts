...
export const loadCalendar = createAction('[Lectures] Load Calendar')
...
export const loadLectures = createAction('[Lectures] Load Lectures')
...
export const resetLectures = createAction('[Lectures] Reset Lectures')
...
export const deleteAllDate = createAction('[Lectures] Delete All Date')
...
export const resetVisiting = createAction('[Lectures] Reset Visiting')
...
export const getVisitingExcel = createAction('[Lectures] Get Visiting Excel')
