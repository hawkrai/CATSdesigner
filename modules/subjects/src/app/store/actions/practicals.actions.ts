...
export const loadPracticals = createAction('[Practicals] Load Practicals')
...
export const loadMarks = createAction('[Practicals] Load Marks')
...
export const resetPracticals = createAction('[Practicals] Reset Practicals')
...
export const getMarksExcel = createAction('[Practicals] Get Marks Excel')

export const getVisitingExcel = createAction('[Practicals] Get Visiting Excel')
...
export const getAsZip = createAction('[Practicals] Get As Zip')
