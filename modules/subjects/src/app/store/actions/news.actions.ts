...
export const disableAllNews = createAction('[News] Disable All News')

export const enableAllNews = createAction('[News] Enable All News')
...
export const resetNews = createAction('[News] Reset News')
