...
const subjectSelector = createFeatureSelector<IAppState, ISubjectState>(
  'subject'
)
...
export const getSubjectId = createSelector(getSelectedSubject, (subject) =>
  !!subject ? subject.id : -1
)

export const getSubjectColor = createSelector(getSelectedSubject, (subject) =>
  !!subject ? subject.color : ''
)

export const getUser = createSelector(subjectSelector, (state) => state.user)
