...
export const labsReducer = createReducer(
  initialLabsState,
  on(
    labsActions.loadLabsScheduleSuccess,
    (state, action): ILabsState => ({
      ...state,
      schedule: action.scheduleProtectionLabs,
    })
  ),
  on(
    labsActions.setLabStudents,
    (state, { students }): ILabsState => ({
      ...state,
      students,
    })
  ),
  on(
    labsActions.loadLabsSuccess,
    (state, action): ILabsState => ({
      ...state,
      labs: action.labs,
    })
  ...
  on(
    labsActions.setLabsSubGroups,
    (state, { subGroups }): ILabsState => ({
      ...state,
      subGroups,
    })
  ),
  on(
    labsActions.loadGroupJobProtectionSuccess,
    (state, { groupJobProtection }): ILabsState => ({
      ...state,
      groupJobProtection,
    })
  ),
  on(
    ...
    (state, { studentJobProtection }): ILabsState => ({
      ...state,
      groupJobProtection: {
  ...
  on(
    labsActions.setJobProtections,
    (state, { hasJobProtections }): ILabsState => ({
      ...state,
      hasJobProtections,
    })
  ),
  on(
    ...
    (state, { labFiles, studentId }): ILabsState => ({
      ...state,
      studentsLabsFiles: {
  ...
  on(
    ...
    (state, { userId, userFileId }): ILabsState => ({
      ...state,
      studentsLabsFiles: {
        ...state.studentsLabsFiles,
        [userId]: (state.studentsLabsFiles[userId] || []).map(
          (ulf): UserLabFile =>
  ...
  on(
    ...
    (state, { userLabFile }): ILabsState => ({
      ...state,
      studentsLabsFiles: {
        ...state.studentsLabsFiles,
        [userLabFile.UserId]: userFilesUtils.sendUserFileSuccess(
          state.studentsLabsFiles[userLabFile.UserId] || [],
          userLabFile
        ),
      },
    })
  ...
  on(
    labsActions.deleteUserLabFileSuccess,
    (state, { userId, userLabFileId }): ILabsState => ({
      ...state,
      studentsLabsFiles: {
        ...state.studentsLabsFiles,
        [userId]: (state.studentsLabsFiles[userId] || []).filter(
