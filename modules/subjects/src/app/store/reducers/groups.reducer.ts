...
export const groupsReducer = createReducer(
  ...
  on(
    ...
    (state, { groups, groupId }): IGroupsState => ({
      ...state,
      groups,
  ...
  on(
    ...
    (state, action): IGroupsState => ({
      ...state,
      currentGroup: action.group,
    })
  ),
  on(
    groupActions.setCurrentGroupById,
    (state, action): IGroupsState => ({
      ...state,
  ...
  on(
    groupActions.setActiveState,
    (state, { isActive }): IGroupsState => ({
      ...state,
      isActive,
    })
  ),
  on(
    groupActions.checkHasInactiveSuccess,
    (state, { hasInactiveGroups }): IGroupsState => ({
      ...state,
      hasInactiveGroups,
    })
  )
