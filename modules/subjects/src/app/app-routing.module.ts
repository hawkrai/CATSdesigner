...
const routes: Routes = [
  ...
  },
  {
    path: 'news',
    loadChildren: () =>
      import('./modules/subject-news/subject-news.module').then(
        (m) => m.SubjectNewsModule
      ),
  },
  {
    path: 'lectures',
    loadChildren: () =>
      import('./modules/lectures/lectures.module').then(
        (m) => m.LecturesModule
      ),
  },
  {
  ...
  },
  {
    path: 'practical',
    loadChildren: () =>
      import('./modules/practical/practical.module').then(
        (m) => m.PracticalModule
      ),
  },
