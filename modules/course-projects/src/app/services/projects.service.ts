...
export class ProjectsService {
  ...
  public getProjects(params: string): Observable<any> {
    return this.http.get('api/courseProject', {
  ...
  public editProject(
    ...
    return this.http.post('api/courseProject', {
      Id: id,
      SubjectId: subjectId,
      Theme: theme,
  ...
  public getStudents(params: string): Observable<any> {
    return this.http.get('api/courseStudent', {
      params: new HttpParams({ fromString: params }),
    })
  }

  public assignProject(projectId: string, studentId: string): Observable<any> {
    return this.http.post('api/courseProjectAssignment', {
      projectId,
      studentId,
    })
  }
