...
export class EditPercentageDialogComponent {
  ...
  private commentControl: FormControl = new FormControl(this.data.comment, [
  ...
  constructor(
    public dialogRef: MatDialogRef<EditPercentageDialogComponent>,
  ...
  isFormInvalid(): boolean {
    return (
      ...
      this.commentControl.invalid ||
      (this.data.total && this.date.invalid)
    )
  }
}
