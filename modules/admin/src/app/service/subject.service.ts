...
export class SubjectService {
    ...
    loadGroupByDates(groupId, start, end): Observable<GroupStatsStatistic> {
      if (start != undefined && end != undefined) {
        return this.http.get<GroupStatsStatistic>(this.api + '/LoadGroup?groupId=' + groupId + '&startDate=' + this.formatDate(start) + '&endDate=' + this.formatDate(end));
      }
      return this.http.get<GroupStatsStatistic>(this.api + '/LoadGroup?groupId=' + groupId);
    }


    loadGroupArchiveByDates(groupId, start, end): Observable<GroupStatsStatistic> {
      if (start != undefined && end != undefined) {
        return this.http.get<GroupStatsStatistic>(this.api + '/LoadGroup?groupId=' + groupId + '&isArchive=true' + '&startDate=' + this.formatDate(start) + '&endDate=' + this.formatDate(end));
      }
