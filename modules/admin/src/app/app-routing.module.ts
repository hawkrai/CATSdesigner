...
const routes: Routes = [
  ...
  {
    path: 'resetPassword/student/:studentId',
    component: ResetThePasswordComponent,
  },
  {
    path: 'resetPassword/lector/:lectorId',
    component: ResetThePasswordComponent,
  },
  ...
  {
    path: 'admin',
    component: AdminGenerateComponent,
    children: [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'main/:groupName/:surname/:start/:end',
        component: MainContolComponent,
      },
      ...
      {
        path: 'statistic/:groupName/:surname/:start/:end',
