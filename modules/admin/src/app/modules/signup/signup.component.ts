  ...
  ngOnInit() {
    this.form = this.formBuilder.group({
        ...
        Password: new FormControl('', [Validators.required, Validators.minLength(6), Validators.maxLength(30),
          Validators.pattern('^[A-Za-z0-9_]{6,30}$'), this.passwordValidator], ValidateEmailNotTaken.createValidator(this.accountService) ),
        ConfirmPassword: new FormControl(''),
        Surname: new FormControl('', [Validators.required, Validators.minLength(3), Validators.pattern('^[А-Яа-яA-Za-z0-9ёЁ _-]{1,30}$'), Validators.maxLength(30)]),
        Name: new FormControl('', [Validators.required, Validators.minLength(3), Validators.pattern('^[А-Яа-яA-Za-z0-9ёЁ _-]{1,30}$'), Validators.maxLength(30)]),
        Patronymic: new FormControl('', [ Validators.pattern('^[А-Яа-яA-Za-z0-9ёЁ _-]{1,30}$'), Validators.maxLength(30)]),
        GroupId: new FormControl('', [Validators.required, Validators.minLength(1), Validators.maxLength(20)]),
        SecretId: new FormControl(1),
        SecretAnswer: new FormControl('', [Validators.required,Validators.pattern('^[А-Яа-яA-Za-z0-9ёЁ _-]{1,30}$'), Validators.minLength(1), Validators.maxLength(30)])
      }, {
