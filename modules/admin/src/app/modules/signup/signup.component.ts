  ...
  deleteSpaces() {
    if (this.form.controls.Name != null)
      this.form.controls.Name.setValue(
        this.form.controls.Name.value.replace(' ', '')
      )
    if (this.form.controls.Surname != null)
      this.form.controls.Surname.setValue(
        this.form.controls.Surname.value.replace(' ', '')
      )
    if (this.form.controls.Name != null)
      this.form.controls.Patronymic.setValue(
        this.form.controls.Patronymic.value.replace(' ', '')
      )
      ...
      () => {
        this.toastr.addSuccessFlashMessage(
          this.translatePipe.transform(
            'text.signup.success_registration',
