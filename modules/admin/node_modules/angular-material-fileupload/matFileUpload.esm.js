import { Injectable, InjectionToken, Inject, PLATFORM_ID, Injector, NgModule, ContentChildren, forwardRef, QueryList, Input, Component, Output, EventEmitter, Pipe, HostListener, Directive, ElementRef, inject, Optional, defineInjectable, NgZone, SkipSelf, isDevMode, ViewEncapsulation, RendererFactory2, LOCALE_ID, ChangeDetectionStrategy, ChangeDetectorRef, SecurityContext, Attribute } from '@angular/core';
import { of, Observable, merge, Subject, Subscription, throwError, forkJoin } from 'rxjs';
import { DOCUMENT, ɵparseCookieValue, isPlatformBrowser, CommonModule } from '@angular/common';
import { MatButtonModule, MatProgressBarModule, MatCardModule } from '@angular/material';
import { DOCUMENT as DOCUMENT$1, BrowserModule, ɵDomRendererFactory2, HAMMER_LOADER, HammerGestureConfig, DomSanitizer } from '@angular/platform-browser';
import { NoopAnimationPlayer, AUTO_STYLE, ɵPRE_STYLE, ɵAnimationGroupPlayer, style, sequence, AnimationBuilder, AnimationFactory } from '@angular/animations';
